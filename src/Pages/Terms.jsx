    ...
    <div>
      ...
      <div className="space-y-5">
        <p className="text-center">
          Welcome to EventNest. By accessing or using our website, you agree to
          be bound by these Terms and Conditions.
        </p>

        <p>
          <span className="text-2xl font-semibold">1. Acceptance of Terms</span>{" "}
          <br />
        ...
        <p>
          <span className="text-2xl font-semibold">2. Changes to Terms</span>{" "}
          <br />
        ...
        <p>
          <span className="text-2xl font-semibold">3. User Accounts</span>{" "}
          <br />
        ...
        <p>
          <span className="text-2xl font-semibold">4. Use of the Website</span>{" "}
          <br />
        ...
        <p>
          <span className="text-2xl font-semibold">6. Third-Party Links</span>{" "}
          <br />
        ...
        <p>
          <span className="text-2xl font-semibold">7. Termination</span> <br />
        ...
        <p>
          <span className="text-2xl font-semibold">9. Privacy Policy</span>{" "}
          <br />
        ...
        <p>
          <span className="text-2xl font-semibold">10. Governing Law</span>{" "}
          <br />
